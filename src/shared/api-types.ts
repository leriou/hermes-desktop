...
export interface HermesAPI {
  ...
  runHermesUpdate: () => Promise<Result>;

  // OAuth provider sign-in
  oauthLogin: (provider: string, profile?: string) => Promise<Result>;
  ...
  writeSoul: (content: string, profile?: string) => Promise<boolean | Result>;
