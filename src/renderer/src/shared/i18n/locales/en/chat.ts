export default {
  ...
  answerClarify: "Type your answer...",
  quickAskTitle:
  ...
  configured: "Configured Aliases",
  available: "Models & Providers",
  noConfiguredModels: "No configured model aliases. Set one up in Settings.",
  noAvailableModels: "All known models are configured.",
  activeChats: "Active",
